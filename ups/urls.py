...
urlpatterns = patterns('',
    ...
    url(r'^pick_ticket_index_dates/(?P<startDate>\d{2}-\d{2}-\d{4})/(?P<stopDate>\d{2}-\d{2}-\d{4})$', views.pick_ticket_index_dates, name='pick_ticket_index_dates'),
    url(r'^pick_ticket_from_ssapi/$', views.pick_ticket_from_ssapi, name='pick_ticket_from_ssapi'),
